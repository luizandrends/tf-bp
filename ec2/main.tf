...
module "tags" {
  source = "git@github.com:PicPay/tech-cross-terraform-modules.git//tags/default?ref=0.1.2"
...
module "ec2_instance" {
  source = "git@github.com:PicPay/tech-cross-terraform-modules.git//ec2/default?ref=0.1.2"
